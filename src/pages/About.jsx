      ...
      <div className="about_container">
        ...
        <div className="panel_container">
          <Panel
            ...
            description={[
              FabricProjectDescr, "Writing and updating AWS Lambdas, ElasticSearch schemas",
          ...
          <Panel
            ...
            description={["Helping students during practical classes with their exercises using R",
          ...
          <Panel
            ...
            description={["Project: Tracker (to read more about it please click here", 
          ...
          <Panel
            ...
            description={["Helping users with the use of financial systems in the University of Edinburgh, often with the use of remote desktop control (Bomgar) or PL/SQL ",
